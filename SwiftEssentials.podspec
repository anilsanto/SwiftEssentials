#
# Be sure to run `pod lib lint SwiftEssentials.podspec' to ensure this is a
...
TODO: Add long description of the pod here.
  ...
  s.source_files = 'SwiftEssentials/Classes/**/*.swift'
  
  # s.resource_bundles = {
  #   'SwiftEssentials' => ['SwiftEssentials/Assets/*.png']
  # }
